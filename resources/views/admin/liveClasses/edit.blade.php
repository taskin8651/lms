...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.liveClass.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.live-classes.update", [$liveClass->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('batch') ? 'is-invalid' : '' }}" name="batch_id" id="batch_id">
                    @foreach($batches as $id => $entry)
                        <option value="{{ $id }}" {{ (old('batch_id') ? old('batch_id') : $liveClass->batch->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('batch'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('teacher') ? 'is-invalid' : '' }}" name="teacher_id" id="teacher_id">
                    @foreach($teachers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('teacher_id') ? old('teacher_id') : $liveClass->teacher->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('class_date') ? 'is-invalid' : '' }}" type="text" name="class_date" id="class_date" value="{{ old('class_date', $liveClass->class_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $liveClass->start_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $liveClass->end_time) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('class_type') ? 'is-invalid' : '' }}" name="class_type" id="class_type">
                    ...
                    @foreach(App\Models\LiveClass::CLASS_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('class_type', $liveClass->class_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meeting_link') ? 'is-invalid' : '' }}" type="text" name="meeting_link" id="meeting_link" value="{{ old('meeting_link', $liveClass->meeting_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('topic') ? 'is-invalid' : '' }}" type="text" name="topic" id="topic" value="{{ old('topic', $liveClass->topic) }}">
                @if($errors->has('topic'))
                    <div class="invalid-feedback">
                        {{ $errors->first('topic') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $liveClass->description) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('recording_link') ? 'is-invalid' : '' }}" name="recording_link" id="recording_link">{{ old('recording_link', $liveClass->recording_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\LiveClass::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $liveClass->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remark') ? 'is-invalid' : '' }}" name="remark" id="remark">{{ old('remark', $liveClass->remark) }}</textarea>
