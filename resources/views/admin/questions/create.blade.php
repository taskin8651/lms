    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('question') ? 'is-invalid' : '' }}" name="question" id="question">{{ old('question') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('option_a') ? 'is-invalid' : '' }}" type="text" name="option_a" id="option_a" value="{{ old('option_a', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('option_d') ? 'is-invalid' : '' }}" type="text" name="option_d" id="option_d" value="{{ old('option_d', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correct_option') ? 'is-invalid' : '' }}" type="text" name="correct_option" id="correct_option" value="{{ old('correct_option', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('negative_marks') ? 'is-invalid' : '' }}" type="text" name="negative_marks" id="negative_marks" value="{{ old('negative_marks', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('explanation') ? 'is-invalid' : '' }}" name="explanation" id="explanation">{{ old('explanation') }}</textarea>
