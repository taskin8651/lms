    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.attendances.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('batch_student') ? 'is-invalid' : '' }}" name="batch_student_id" id="batch_student_id">
                    @foreach($batch_students as $id => $entry)
                        <option value="{{ $id }}" {{ old('batch_student_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('attendance_date') ? 'is-invalid' : '' }}" type="text" name="attendance_date" id="attendance_date" value="{{ old('attendance_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('punch_in_time') ? 'is-invalid' : '' }}" type="text" name="punch_in_time" id="punch_in_time" value="{{ old('punch_in_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('punch_out_time') ? 'is-invalid' : '' }}" type="text" name="punch_out_time" id="punch_out_time" value="{{ old('punch_out_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('punch_in_lat') ? 'is-invalid' : '' }}" type="text" name="punch_in_lat" id="punch_in_lat" value="{{ old('punch_in_lat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('punch_in_lng') ? 'is-invalid' : '' }}" type="text" name="punch_in_lng" id="punch_in_lng" value="{{ old('punch_in_lng', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('punch_in_location') ? 'is-invalid' : '' }}" name="punch_in_location" id="punch_in_location">{{ old('punch_in_location') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('punch_out_lat') ? 'is-invalid' : '' }}" type="text" name="punch_out_lat" id="punch_out_lat" value="{{ old('punch_out_lat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('punch_out_lng') ? 'is-invalid' : '' }}" type="text" name="punch_out_lng" id="punch_out_lng" value="{{ old('punch_out_lng', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('punch_out_loc') ? 'is-invalid' : '' }}" name="punch_out_loc" id="punch_out_loc">{{ old('punch_out_loc') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marked_by') ? 'is-invalid' : '' }}" name="marked_by_id" id="marked_by_id">
                    @foreach($marked_bies as $id => $entry)
                        <option value="{{ $id }}" {{ old('marked_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
