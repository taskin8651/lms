    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.batches.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('class_level') ? 'is-invalid' : '' }}" name="class_level_id" id="class_level_id">
                    @foreach($class_levels as $id => $entry)
                        <option value="{{ $id }}" {{ old('class_level_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('timing') ? 'is-invalid' : '' }}" type="text" name="timing" id="timing" value="{{ old('timing', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fees_amount') ? 'is-invalid' : '' }}" type="text" name="fees_amount" id="fees_amount" value="{{ old('fees_amount', '') }}">
