    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.announcements.update", [$announcement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('audience') ? 'is-invalid' : '' }}" name="audience_id" id="audience_id">
                    @foreach($audiences as $id => $entry)
                        <option value="{{ $id }}" {{ (old('audience_id') ? old('audience_id') : $announcement->audience->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publish_date') ? 'is-invalid' : '' }}" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date', $announcement->publish_date) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\Announcement::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $announcement->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expire_date') ? 'is-invalid' : '' }}" type="text" name="expire_date" id="expire_date" value="{{ old('expire_date', $announcement->expire_date) }}">
